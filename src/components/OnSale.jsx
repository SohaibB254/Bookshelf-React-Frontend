...
const OnSale = () => {
    ...
    return (
        <div className='h-auto font-inter text-[30px] overflow-x-hidden font-inter  px-8 sm:px-20 pt-10'>
                    ...
                    animatedBooks.map((elm, idx) => {
                        return (
                            <motion.div key={idx}
                                ...
                                className='sm:h-[70vh] group h-[40vh] border border-black/50 w-[250px]   sm:w-[30vw] cursor-pointer relative'>
            ...
            <Link to={`/store/${encodeURIComponent('salebooks')}`} className='text-base sm:mx-0 mx-8  text-center my-4 hover:underline w-auto' >See More</Link>
        </div>
    );
}
