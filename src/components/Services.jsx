...
const Services = () => {
  return (
    <div className=" lg:text-[32px] sm:text-[23px] font-inter my-12">
      <h1 className="text-center text-[1.3em]  font-semibold">
        Why Choose Us?
      </h1>
      <div
        id="servicesContainer"
        className="bg-black lg:px-20 px-5 h-full py-12 text-white mt-10 items-center justify-center lg:justify-normal  flex flex-wrap gap-5"
      >
        <motion.div
          initial={{
            opacity: 0,
          ...
          id="serviceCard"
          className="w-[400px] lg:h-[300px] border overflow-hidden px-4 py-2 flex flex-col items-center rounded-md"
        >
          <h1 className="cursor-pointer   transition text-green-500">
            Fast Delivery
          </h1>
          <p className="sm:text-[0.6em] text-[0.8em] ">
