...
const About = () => {
  return (
    <>
    <div id='aboutContainer' className='text-[32px] sm:px-8  pt-8'>
      <h1 className='font-semibold sm:text-left text-center text-[0.8em] sm:text-[1em]  font-inter sm:pl-4 move-elm-ltr'>BookShelf - A Castle for Readers</h1>
      <div id='aboutContentContainer' className='h-auto  gap-4 text-[0.7em]  mt-8 font-inter flex-wrap sm:flex-nowrap flex px-4 py-8 text-white bg-gray-950 rounded-md'>
        ...
        <div className=' sm:w-[50%] border group cursor-pointer fade-elm border-white rounded-md p-4'>
