  ...
  return (
    ...
    <div className=' font-inter w-full h-fit pt-12 flex justify-center  ' >
        ...
        <form className=' flex flex-col gap-2' action="">
            ...
            <input class="px-4 rounded border block  border-black/20 py-2" type={`${isShown?'text':'password'}`} onChange={(e)=>setPassword(e.target.value)} value={password} name="name" placeholder="Password" id=""/>
