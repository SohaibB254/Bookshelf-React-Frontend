...
const Home = () => {
  return (
    <>
      <div id='Home' className=' w-screen flex-col lg:flex-row flex font-sans justify-center     md:items-center text-white h-[90vh]'>
        <div className='h-auto w-screen pt-10 lg:pt-0 lg:w-[50vw]  flex
       flex-col items-center'>
        {/* Home left */}
          <div className='w-[100%] px-10 lg:pl-20 h-[70%] '>
            <h1 id='TitleText' className='sm:text-[46px] md:text-[76px] text-[36px] text-center lg:text-left mt-10 lg:mt-0 font-merri  font-bold fade-elm'>An Online Library <br />And<span className='text-[#24BF6C]'> Book Store</span> </h1>
            <p className='font-inter mt-6 text-center lg:text-left fade-elm'>Explore worlds from <strong>millions</strong> of authors across every genre imaginable <br /><span className='italic font-inter hidden sm:block'>Epic tales, self-help gems, and timeless classics</span> </p>
        ...
        <div className='flex items-end lg:justify-end lg:w-[50vw] sm:h-full  h-[50%]'>
